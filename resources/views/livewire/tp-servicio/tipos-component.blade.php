            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Tipos de servicios</h6>
                    </div>
                    {{-- boton añadir --}}
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                              ...
                              <li class="page-item {{ $tservicios->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ $tservicios->previousPageUrl() }}" tabindex="-1">
                              ...
                              <!-- Enlaces de páginas -->
                              @php
                                $currentPage = $tservicios->currentPage();
                                $lastPage = $tservicios->lastPage();
                              ...
                              @for ($i = $startLink; $i <= $endLink; $i++)
                                <li class="page-item {{ $currentPage === $i ? 'active' : '' }}">
                                  <a class="page-link" href="{{ $tservicios->url($i) }}">{{ $i }}</a>
                                </li>
                              @endfor
                              ...
                              <li class="page-item {{ $tservicios->hasMorePages() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $tservicios->nextPageUrl() }}">
                                  <span class="material-icons">
