                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="file" wire:model="newimage" class="form-control border border-2 p-2" placeholder="Ingrese una imagen">
                                    @if ($newimage)
                                        <img src="{{$newimage->temporaryUrl()}}" wideth="120" alt="">
                                        @else
                                            <img src="{{asset('assets/img/areas/')}}/{{$imagen}}" wideth="120" alt="">
                                    @endif
