                    ...
                    <div class="table-responsive p-0">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                              ...
                              <li class="page-item {{ $notasCompra->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ $notasCompra->previousPageUrl() }}" tabindex="-1">
                              ...
                              <!-- Enlaces de páginas -->
                              @php
                                $currentPage = $notasCompra->currentPage();
                                $lastPage = $notasCompra->lastPage();
                              ...
                              @for ($i = $startLink; $i <= $endLink; $i++)
                                <li class="page-item {{ $currentPage === $i ? 'active' : '' }}">
                                  <a class="page-link" href="{{ $notasCompra->url($i) }}">{{ $i }}</a>
                                </li>
                              @endfor
                              ...
                              <li class="page-item {{ $notasCompra->hasMorePages() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $notasCompra->nextPageUrl() }}">
                                  <span class="material-icons">
