                    ...
                    <form wire:submit.prevent='storeTansaccion'>
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control border border-2 p-2" wire:model="membresia_id">
                                    ...
                                    @foreach ($membresias as $membresia)
                                        <option value="{{ $membresia->id }}">{{ $membresia->nombre }} - {{ $membresia->precio }}</option>
                                    @endforeach
                                </select>
                                @error('membresia_id')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input wire:model="monto" type="number" class="form-control border border-2 p-2"@if(!$montoEditable) readonly @endif>
                                @error('monto')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                            </div>
