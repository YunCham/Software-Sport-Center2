                    ...
                    <div class="table-responsive p-0">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                              ...
                              <li class="page-item {{ $transaccions->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ $transaccions->previousPageUrl() }}" tabindex="-1">
                              ...
                              <!-- Enlaces de páginas -->
                              @php
                                $currentPage = $transaccions->currentPage();
                                $lastPage = $transaccions->lastPage();
                              ...
                              @for ($i = $startLink; $i <= $endLink; $i++)
                                <li class="page-item {{ $currentPage === $i ? 'active' : '' }}">
                                  <a class="page-link" href="{{ $transaccions->url($i) }}">{{ $i }}</a>
                                </li>
                              @endfor
                              ...
                              <li class="page-item {{ $transaccions->hasMorePages() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $transaccions->nextPageUrl() }}">
                                  <span class="material-icons">
