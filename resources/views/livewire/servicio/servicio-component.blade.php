                    ...
                    <div class="table-responsive p-0">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                              ...
                              <li class="page-item {{ $servicios->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ $servicios->previousPageUrl() }}" tabindex="-1">
                              ...
                              <li class="page-item {{ $servicios->hasMorePages() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $servicios->nextPageUrl() }}">
                                  <span class="material-icons">
