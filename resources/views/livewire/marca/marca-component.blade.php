                    ...
                    <div class="table-responsive p-0">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                              ...
                              <li class="page-item {{ $marcas->onFirstPage() ? 'disabled' : '' }}">
                                <a class="page-link" href="{{ $marcas->previousPageUrl() }}" tabindex="-1">
                              ...
                              @for ($i = $startLink; $i <= $endLink; $i++)
                                <li class="page-item {{ $currentPage === $i ? 'active' : '' }}">
                                  <a class="page-link" href="{{ $marcas->url($i) }}">{{ $i }}</a>
                                </li>
                              @endfor
                              ...
                              <li class="page-item {{ $marcas->hasMorePages() ? '' : 'disabled' }}">
                                <a class="page-link" href="{{ $marcas->nextPageUrl() }}">
                                  <span class="material-icons">
