        ...
        <div class="card card-body mx-3 mx-md-4 mt-n6">
            <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                    ...
                    @endif
                    <form wire:submit.prevent='updateMembresia'>
                        <div class="row">
...
---con livew --}}
                            {{-- <div>
                                <div class="form-check">     con  antes de preguntar c chargpt  sin nada solo tus cambios
                                    @foreach ($servicios as $servicio)
                            ...
                            {{-- <div >
                                <div class="row">
                                    @foreach ($servicios->chunk(ceil(count($servicios) / 3)) as $chunk)
                                        <div class="col-md-4">
                                            <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item border-0 px-0">
                                                        <div class="form-check form-switch ps-0">
                                                            <input class="form-check-input ms-auto" type="checkbox"
                                                                value="{{ $servicio->id }}" id="servicio_{{ $servicio->id }}"
                                                                wire:model="selectedServicios.{{ $servicio->id }}"
                                                                @if (in_array($servicio->id, $selectedServicios)) checked @endif>
